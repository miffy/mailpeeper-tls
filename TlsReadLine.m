...
//  MailPeeper
//
//  Created by miff in 2010.
//

#import "TlsReadLine.h"
#import "TlsTCPClient.h"

@implementation TlsReadLine
...
- (TlsReadLine_recv_t)recvLine
{
	...
	for(aLoop = YES; aLoop; ){
		...
		if(mPopIndex >= mMaxIndex){ //ならば読み取りをする
			...
			TlsTCPClient_send_recv_result aRR;
			do{
				aRR = [mS.client recv:mReadBuff size:TlsReadLine_BuffSize];
